  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-center justify-between text-xs mb-2">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-foreground bg-white/10 px-2 py-0.5 rounded">{q.num}</span>
                ...
                <div className="text-sm text-foreground font-medium mb-2">{q.text}</div>

                {q.options && (
                  <div className="grid grid-cols-2 gap-2 text-xs text-muted mb-2">
                    {q.options.map((opt) => (
                      <div key={opt} className="p-2 rounded bg-card border border-border">{opt}</div>
                    ))}
                  </div>
                )}
        ...
        <div className="p-5 rounded-2xl bg-surface border border-border space-y-4 h-fit">
          <div className="flex items-center gap-2 text-foreground font-display text-sm font-bold border-b border-border pb-3">
          ...
          <div className="space-y-2">
            <label className="text-xs font-semibold text-muted">Regeneration Option:</label>
            {[
