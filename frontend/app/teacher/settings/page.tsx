    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-surface border border-border space-y-4 max-w-2xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-foreground text-base">{user?.name || "Vaanchhit Agarwal"}</div>
            <div className="text-xs text-muted">{user?.school || "Delhi Public School"} · Senior Biology & Science Teacher</div>
          </div>
        </div>

        <div className="pt-4 border-t border-border space-y-3 text-xs">
          <div>
            <span className="text-muted">Assigned Subjects:</span>
            <div className="text-foreground font-medium mt-0.5">Biology, Science, Economics</div>
          </div>

          <div>
            <span className="text-muted">Assigned Grades:</span>
            <div className="text-foreground font-medium mt-0.5">Class 9, Class 10, Class 12</div>
          </div>

          <div>
            <span className="text-muted">AI Model Router Tiering:</span>
